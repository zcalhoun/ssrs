...
large_images="/home/sl636/inria/AerialImageDataset/val_masks/*.tif"

for image in $large_images; do
	echo Working on ${image}
	gdal_retile.py -targetDir /home/sl636/inria/AerialImageDataset/retiled_val_masks/ -ps 224 224 $image
done
